let player1Piece = document.getElementById("pieces1color");
let player2Piece = document.getElementById("pieces2color");

function applyCustomization(){
    let selected1Color = player1Piece.value;
    let selected2Color = player2Piece.value;
    let selectedColours = [ selected1Color , selected2Color]
...
var ValidMoves = function(){
    ...
    function setValidMoves(vm) {
        // if the player has pieces on the bar
...
function drawBoard(brd) {
    ...
    var boardInnerColor = "#b2977b";
    var triangleColor1 = "#be925b";
    var triangleColor2 = "#895635";
    var triangleBorderColor = "#444";
    // var blackCheckerColor = "#333";
    // var whiteCheckerColor = "#DDD";
    var blackCheckerColor = applyCustomization()[0].toString();
    var whiteCheckerColor = applyCustomization()[1].toString();
    
    var cubeBodyColor = "#663301";
    var cubeNumberColor = "#663301";
    var buttonBackgroundColor = "#c0ab99";
    var buttonBorderColor = "#333";
    var buttonTextColor = "#800000FF";
    var blackDiceBodyColor = applyCustomization()[0].toString();
    var blackDiceDotColor = "#DDD";
    var whiteDiceBodyColor = applyCustomization()[1].toString();
    ...
    function drawPoint(j, point) {
        ...
        if (point[0] > 5) {  //draw number to the last checker if they are more than 5
            ctx.save();
    ...
    function drawCube(cb) {
        ...
        roundRect(ctx, 0, 0, cb.size, cb.size, cb.size*0.05, true, false);
